function [bestSolution, bestEnergy, history] = crossEntropyOptimizerIsotropic(d, n, sampleSize, eliteSize, maxIterations, smoothingFactor, minStd)
    % 交叉熵优化算法实现
    % 输入参数:
    %   d: 维度
    %   n: 向量数量
    ...
    for iter = 1:maxIterations
        ...
        parfor s = 1:sampleSize  % 使用并行计算加速
            ...
            % 计算能量
            energy = omegak_batching_optimized_Bloch(n, candidate, d) / n; % Isotropic 态
            % energy = compute_max_norm_optimized(candidate, d)/n; % 
